...
public class GameShould {
    ...
    return_each_player_score() {
        add(2).pointsToScore(playerA.getScore());
        add(1).pointsToScore(playerB.getScore());
    ...
    return_that_both_players_have_the_same_score() {
        add(2).pointsToScore(playerA.getScore());
        add(2).pointsToScore(playerB.getScore());
    ...
    return_deuce_when_both_players_have_as_score_40() {
        add(3).pointsToScore(playerA.getScore());
        add(3).pointsToScore(playerB.getScore());
    ...
    return_playerA_has_an_advantage_when_deuce_happen_and_playerA_scores() {
        add(4).pointsToScore(playerA.getScore());
        add(3).pointsToScore(playerB.getScore());
    ...
    return_playerB_has_an_advantage_when_deuce_happen_and_playerB_scores() {
        add(3).pointsToScore(playerA.getScore());
        add(4).pointsToScore(playerB.getScore());
